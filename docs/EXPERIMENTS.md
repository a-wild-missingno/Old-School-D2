...
| 2026-08-22 | [complete build-data readiness probe](experiments/2026-08-22-complete-build-data-readiness-probe.md) | Source-backed metadata-only readiness differential | READY: report expands from eight to all eleven worker completion domains; no client run yet |
