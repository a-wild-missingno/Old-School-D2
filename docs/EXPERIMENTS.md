...
| 2026-08-21 | [external trace provenance comparison](experiments/2026-08-21-external-trace-provenance.md) | Metadata-only trace/baseline startup comparison | PASS: differing DLL identities are the first evidenced pre-transport divergence; causality remains unknown |
