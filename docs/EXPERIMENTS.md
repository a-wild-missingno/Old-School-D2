...
| 2026-08-30 | [package-trust comparator audit](client-analysis/package-trust-comparator-audit.md) | Source-only working/offline comparator differential | COMPLETE: integrity behavior is an upstream local difference; no behavior ported |
| 2026-08-30 | [package-trust compatibility classification](experiments/2026-08-30-package-trust-compatibility-classifier.md) | CI-built read-only three-target classifier | COMPLETE: all targets present; black screen/service-10 absence unchanged; no integrity behavior changed |
| 2026-08-30 | [post-service-29 family-zero source-seed audit](client-analysis/post-service29-family0-source-seed-audit.md) | Current-reference vs external source comparison | COMPLETE: uniquely identified manager-key fallback differential; causal effect unproven |
| 2026-08-30 | [family-zero seed-affordance observer](experiments/2026-08-30-family0-seed-affordance-observer.md) | Read-only aggregate state observation | SOURCE-TESTED: 22 tests passed; Windows CI artifact pending |
| 2026-08-30 | [family-zero sweep invocation source limit](client-analysis/family0-sweep-invocation-source-limit.md) | Source-only predecessor/eligibility audit | COMPLETE: native sweep caller/predicate is absent from authorized source; offline static analysis needs separate authorization |
| 2026-08-30 | [family-zero offline static caller analysis](experiments/2026-08-30-family0-static-caller-analysis.md) | Read-only aggregate executable-file scan | COMPLETE: source-defined runtime signature had zero file matches in both runtimes; loaded-process analysis needs separate authorization |
| 2026-08-30 | [family-zero loaded predecessor analysis](experiments/2026-08-30-family0-loaded-predecessor-analysis.md) | Read-only loaded-process/pre-detour aggregate scan | COMPLETE: target has one direct tail-jump predecessor; second-hop classifier is the only bounded next candidate |
