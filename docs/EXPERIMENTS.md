...
| 2026-08-22 | [character-signin predecessor source limit](experiments/2026-08-22-character-signin-predecessor-source-limit.md) | Source-only call-site review | COMPLETE: no unique predecessor encoded in authorized source; static binary analysis requires explicit scope |
