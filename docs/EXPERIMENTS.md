...
| 2026-08-22 | [in-process character-signin probe design](experiments/2026-08-22-in-process-character-signin-probe-design.md) | Review-only bounded metadata proposal | DESIGN: no code/deploy/run; exact existing signature and max-four caller-RVA bounds |
